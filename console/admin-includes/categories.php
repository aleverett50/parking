...
<div class="table-responsive">
	...
	print '<tr><td>'.$row->title.'</td><td>/'.$row->seo_url.'</td><td>'.$row->meta_description.'</td><td>'.$row->meta_title.'</td><td><a class="btn btn-primary" href="account.php?page=category&action=edit&id='.$row->id.'">Edit <i class="fa fa-edit"></i></a> <a class="btn btn-primary" href="account.php?page=categories&action=delete&id='.$row->id.'">Delete <i class="fa fa-remove"></i></a></td></tr>';
